        ...
        <div class="col-md-4">
            <a href="{{ route('account.transfer') }}" class="text-decoration-none">
                ...
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Transfer</span>
                </div>
            </a>
            ...
            <a href="{{ route('account.referrals') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Referrals</span>
                </div>
            </a>
            ...
            <a href="{{ route('account.notification') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Notifications</span>
                </div>
            </a>
            ...
            <a href="{{ route('account.notification') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Push Notifications</span>
                </div>
            </a>
            ...
            <a href="{{ route('verifications.index') }}" class="text-decoration-none">
                ...
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Account Verifications</span>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('account.email') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Update Email</span>
            ...
            <a href="{{ route('account.password') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Update Password</span>
                </div>
            </a>
            ...
            <a href="{{ route('account.address') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Update Contact Info</span>
                </div>
            </a>
            ...
            <a href="{{ route('account.photo') }}" class="text-decoration-none">
                <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                    ...
                    <span class="text-header fw-bold">Update Profile Photo</span>
                </div>
            </a>
        </div>
    </div>
