  ...
  <div class="relative z-10 max-w-6xl mx-auto px-6">
    ...
    <div class="max-w-5xl mb-14">
      <p class="text-[15px] md:text-base leading-7 md:leading-8 text-gray-600 dark:text-gray-300">
        ElevateCapital is an online Forex and cryptocurrency STP broker providing CFD trading on hundreds of assets and
        optimal trading conditions within the award-winning MT4 platform. ElevateCapital offers deep liquidity, generous
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
      ...
      <div class="flex flex-col gap-6">
        <div
          ...
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            ElevateCapital stands out for its transparency and user-friendly features. I especially like the
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            Any issues I had were quickly resolved by the ElevateCapital support team. They're responsive, polite, and
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            I’ve been using ElevateCapital for the past 8 months, and I couldn’t be happier. The interface is clean and
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            I was initially cautious, but ElevateCapital proved to be a solid and trustworthy platform. Withdrawals are
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            I switched to ElevateCapital after years with another broker, and the difference is night and day. The
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            What I love most about ElevateCapital is the copy trading feature. As someone who doesn't have hours to
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            ElevateCapital made forex trading accessible for me. The learning resources combined with a demo account
      ...
      <div class="flex flex-col gap-6">
        <div
          class="bg-white dark:bg-[#0b1118] p-8 md:p-10 shadow-xl rounded-none border border-gray-100 dark:border-gray-800">
          <p class="text-black dark:text-gray-200 font-medium text-lg leading-relaxed">
            Security was my biggest concern when choosing a broker, and ElevateCapital has exceeded my expectations.
