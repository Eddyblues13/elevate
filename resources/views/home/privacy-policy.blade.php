    ...
    <div class="max-w-7xl mx-auto px-6 py-12 lg:py-20">
        ...
        <div class="w-full mx-auto bg-white dark:bg-[#0b1118] p-8 lg:p-12 shadow-xl border border-gray-200 dark:border-[#363c4e]">
            ...
            <div class="space-y-8 text-base leading-relaxed text-black/80 dark:text-[#a5bdd9]">
                ...
                <p>
                    By using the Services, you agree to the terms of this Privacy Policy, and your continued use of the Services constitutes your ongoing agreement to the Privacy Policy. In this Privacy Policy, you will read about:
                </p>
                ...
                <div>
                    <h3 class="text-xl font-bold text-black dark:text-white mb-2">With Whom We Share the Information:</h3>
                    <p>
                        We do not rent, sell, or share your Personal Information with third-parties except as described in this Privacy Policy. We may share Personal Information with subsidiaries, affiliated companies, subcontractors, auditors or advisers of our business processes, and any potential purchasers or investors in the company. We may also disclose Personal Information if we have a good faith belief that disclosure is helpful or reasonably necessary to comply with applicable law, enforce our policies, or prevent harm to us or third parties.
                    </p>
                </div>

                <div>
                    <h3 class="text-xl font-bold text-black dark:text-white mb-2">For How Long We Retain the Information:</h3>
                    <p>
                        We respect your privacy rights and therefore you may contact us at any time to access, delete, change, or update any Personal Information relating to you. Unless you instruct us otherwise, we retain the information we collect for as long as needed to provide the Services and to comply with our legal obligations, resolve disputes, and enforce our agreements.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        We may revise this Privacy Policy from time to time, in our sole discretion, and the most current version will always be posted on our website. In the event of a material change to the Privacy Policy, we will notify you through the Services or via email. Your continued use of the Services following the notification of such amendments constitutes your acknowledgment and consent of such amendments.
                    </p>
                </div>
