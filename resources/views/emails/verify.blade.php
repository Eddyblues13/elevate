        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr><td align="center">
            <div class="card">
                ...
                <div class="body-content">
                    ...
                    <p>Welcome to ElevateCapital! Your registration is successful and you are just one step away from verifying your account.</p>
                    <p>Please use the activation code below to verify your email address:</p>
                    <div class="code-box">
                        <div class="code-value">{{ $validToken }}</div>
                    </div>
