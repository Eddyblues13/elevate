        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr><td align="center">
            <div class="card">
                ...
                <div class="body-content">
                    ...
                    <p>A user has initiated a new <strong>{{ strtolower($actionType) }}</strong> on the platform.</p>
                    ...
                    <p>Please review this {{ strtolower($actionType) }} in the admin dashboard.</p>
                    ...
                    <p style="margin-bottom:0;">Kind Regards,<br><strong style="color:#1e1b4b;">ElevateCapital System</strong></p>
                </div>
                <div class="footer">
