@section('title', 'Reset Password - ElevateCapital')
@include('home.header')
            ...
            <form id="resetPasswordForm">
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        <input type="password" name="password" id="password" class="reset-form-input" placeholder="Enter new password (min 8 characters)" required>
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        <input type="password" name="password_confirmation" id="password_confirmation" class="reset-form-input" placeholder="Confirm your new password" required>
